"""
/* This test case replicates a shot in the pool table and prints the first 10 and 143-153 frames of said shot                          */
/* This program will print the frames at a 0.01s rate, the output should be the same as Part3_Test1.py for the first 10 frames         */
"""
