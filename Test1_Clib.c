/*
** This test case is meant to check for faults
** in the C library and the Physics, this includes
** adding balls to table, "shoot", "roll", etc...
*/
...
void phylib_print_object( phylib_object *object )
{
  ...
  switch (object->type)
  {
    case PHYLIB_STILL_BALL:
      printf( "STILL_BALL (%d,%6.7lf,%6.7lf)\n",
    ...
    case PHYLIB_ROLLING_BALL:
      printf( "ROLLING_BALL (%d,%6.7lf,%6.7lf,%6.7lf,%6.7lf,%6.7lf,%6.7lf)\n",
    ...
    case PHYLIB_HOLE:
      printf( "HOLE (%6.7lf,%6.7lf)\n",
	      object->obj.hole.pos.x,
	      object->obj.hole.pos.y );
      break;

    case PHYLIB_HCUSHION:
      printf( "HCUSHION (%6.7lf)\n",
	      object->obj.hcushion.y );
      break;

    case PHYLIB_VCUSHION:
      printf( "VCUSHION (%6.7lf)\n",
