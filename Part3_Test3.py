"""
/* This test case replicates a shot in the pool table                                                   */
/* This program will write to database (phylib.db will be created)                                      */
/* It might take a very long time on docker container or ssh tunnel, ignore this if response is quick   */
"""
